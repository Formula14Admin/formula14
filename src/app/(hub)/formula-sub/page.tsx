...
export default function FormulaSubPage() {
  return (
    <div className="flex h-screen flex-col items-center justify-center" style={{ backgroundColor: '#f4f6f9' }}>
      <div className="max-w-md rounded-2xl border border-gray-200 bg-white p-10 text-center shadow-sm">
        ...
        >
          <IconArrowsExchange size={28} style={{ color: '#6BA3D6' }} strokeWidth={1.5} />
        </div>
        <span
        ...
        <h1 className="mb-2 mt-3 text-2xl font-bold text-gray-900">FormulaSub</h1>
        <p className="text-sm text-gray-500">Manage player substitutions and rotation patterns during games</p>
      </div>
    </div>
  )
}
