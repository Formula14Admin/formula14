...
export default function PocketPlaysPage() {
  ...
  function handleSavePlay() {
    ...
    setSavedPlays((prev) => {
      const updated = loadedPlayId
        ...
        : [...prev, play]
      localStorage.setItem('pocketPlays', JSON.stringify(updated))
      return updated
    })
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden" style={{ backgroundColor: '#f4f6f9' }}>
      ...
      <div className="shrink-0 border-b border-gray-200 bg-white px-6 py-4">
        <h1 className="text-xl font-bold text-gray-900">Pocket Plays</h1>
